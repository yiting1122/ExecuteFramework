...
public abstract class MAbstractQueuedSynchronizer
    extends MAbstarctOwnableSynchronizer
     ...
     */
    public class ConditionObject implements MCondition, java.io.Serializable {
    ...
    public static Unsafe getUnsafe() {
    	   try {
    	      ...
    	      throw new Error("getUnsafe error");
    	   }
    	}
    static {
        try {
            stateOffset = unsafe.objectFieldOffset
                (MAbstractQueuedSynchronizer.class.getDeclaredField("state"));
            headOffset = unsafe.objectFieldOffset
                (MAbstractQueuedSynchronizer.class.getDeclaredField("head"));
            tailOffset = unsafe.objectFieldOffset
                (MAbstractQueuedSynchronizer.class.getDeclaredField("tail"));
